To Run:
1. Manually install numpy-1.12.0rc1+mkl because it's not available via pip
...
3. Download images - https://www.dropbox.com/s/ggp6tey2rpfk7tv/images.zip?dl=0
4. Extract images to ./images
5. Run example.py
